...
| cb_retrieve_autoruns | Retrieve browsing history from an endpoint as an HTML data file. Uses the utility: https://www.nirsoft.net/utils/browsing_history_view.html  |
