...
# This function will retrieve the Microsoft Antimalware and/or Windows Defender Windows event logs from an endpoint in corresponding TXT files.
...
class FunctionComponent(ResilientComponent):
    ...
    def _cb_retrieve_windows_av_events_function(self, event, *args, **kwargs):
        """Function: Retrieves all Windows AV events from Windows Defender and Microsoft Security Client (Microsoft Antimalware)."""
        ...
        try:
            ...
            while timeouts <= MAX_TIMEOUTS:  # Max timeouts before aborting
                ...
                try:
                    ...
                    yield StatusMessage('[SUCCESS] Queried all Microsoft Antimalware Windows events on Sensor!')
