...
# Date: 04/24/2019 - Modified: 04/24/2019
# Author: Jared F

"""Function implementation"""
#   @function -> cb_force_reboot_with_message
#   @params -> integer: incident_id, string: hostname, integer: minutes, string: custom_message
...
class FunctionComponent(ResilientComponent):
    """Component that implements Resilient function 'cb_force_reboot_with_message"""
    ...
    def _cb_force_reboot_with_message_function(self, event, *args, **kwargs):
        """Function: Forces an endpoint to reboot and displays a custom message."""
        results = {}
        ...
        try:
            ...
            if custom_message is None: custom_message = 'System restarting for cyber security reasons.'
